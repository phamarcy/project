    ...
    $mail->Subject = $sendsubject;
      ...
      if($type=='1')
        ...
        elseif ($type=='2')
        {
          switch ($status) {
              case '0':
                  $bodystring = "รหัสกระบวนวิชา ".$course_id." ผู้รับผิดชอบกระบวนวิชา คุณ".$name."<br>"."แบบขออนุมัติเชิญอาจารย์พิเศษอยู่ระหว่างการกรอกข้อมูล";
                  break;
              case '1':
                  $bodystring = "รหัสกระบวนวิชา ".$course_id." ผู้รับผิดชอบกระบวนวิชา คุณ".$name."<br>"."แบบขออนุมัติเชิญอาจารย์พิเศษอยู่ระหว่างการรอพิจารณา";
                  break;
              case '2':
                  $bodystring = "รหัสกระบวนวิชา ".$course_id." ผู้รับผิดชอบกระบวนวิชา คุณ".$name."<br>"."คณะกรรมการไม่เห็นชอบกับแบบขออนุมัติเชิญอาจารย์พิเศษ";
                  break;
              case '3':
                  $bodystring = "รหัสกระบวนวิชา ".$course_id." ผู้รับผิดชอบกระบวนวิชา คุณ".$name."<br>"."แบบขออนุมัติเชิญอาจารย์พิเศษต้องมีการแก้ไข";
                  break;
              case '4':
                  $bodystring = "รหัสกระบวนวิชา ".$course_id." ผู้รับผิดชอบกระบวนวิชา คุณ".$name."<br>"."แบบขออนุมัติเชิญอาจารย์พิเศษเห็นชอบจากคณะกรรมการระดับภาคแล้ว";
                  break;
              case '5':
                  $bodystring = "รหัสกระบวนวิชา ".$course_id." ผู้รับผิดชอบกระบวนวิชา คุณ".$name."<br>"."แบบขออนุมัติเชิญอาจารย์พิเศษอยู่ระหว่างการรอคณะกรรมการอนุมัติ";
                  break;
              case '6':
                  $bodystring = "รหัสกระบวนวิชา ".$course_id." ผู้รับผิดชอบกระบวนวิชา คุณ".$name."<br>"."แบบขออนุมัติเชิญอาจารย์พิเศษต้องมีการแก้ไข";
                  break;
              case '7':
                  $bodystring = "รหัสกระบวนวิชา ".$course_id." ผู้รับผิดชอบกระบวนวิชา คุณ".$name."<br>"."แบบขออนุมัติเชิญอาจารย์พิเศษได้รับการเห็นชอบจากคณะกรรมการแล้ว";
                  break;
                default:
                  return 'error';
                  break;
