												...
												<div class="panel panel-default">
													<div class="panel-heading">
														<h3 class="panel-title" style="font-size:14px;">
															...
															<?php if (isset($value_course['pdf']) && $_SESSION['level']==3 && $value_course['evaluate']['status']!=0 || $_SESSION['admission']==3): ?>
																...
																<div class="panel panel-default">
																	<div class="panel-heading">
																		<h3 class="panel-title" style="font-size:14px;">
																			...
																			<?php if (isset($valuesp['pdf']) && $_SESSION['level']==3 && $valuesp['status']!=0 || $_SESSION['admission']==3): ?>
