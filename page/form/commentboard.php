                              ...
                              <div class="panel-heading clearfix">
                                ...
                                <div class="btn-group pull-right eva">
                                  ...
                                  <?php if (isset($eva['syllabus']) ): ?>
                                    <a href="../../files<?php echo $eva['syllabus'] ?>" target="_blank" TITLE="คลิ็ก ! เพื่ดเปิดPDF"><button type="button" class="btn btn-default btn-sm" >ดาวน์โหลด course syllabus</button></a>
                                    <?php endif; ?>
